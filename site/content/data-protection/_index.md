...
content: >-
  ...
  einen besonders hohen Stellenwert für die Geschäftsleitung der Piers Goffart /
  Lavamachine. Eine Nutzung der Internetseiten der  Piers Goffart / Lavamachine
  ...
  mit den für die Piers Goffart / Lavamachine geltenden landesspezifischen
  ...
  Die Internetseiten der Piers Goffart / Lavamachine verwenden Cookies. Cookies
  ...
  Durch den Einsatz von Cookies kann die Piers Goffart / Lavamachine den Nutzern
  ...
  Die Internetseite der Piers Goffart / Lavamachine erfasst mit jedem Aufruf der
  ...
  Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die Piers
  Goffart / Lavamachine keine Rückschlüsse auf die betroffene Person. Diese
  ...
  werden durch die Piers Goffart / Lavamachine daher einerseits statistisch und
  ...
  Die Piers Goffart / Lavamachine bietet den Nutzern auf einem Blog, der sich
  auf der Internetseite des für die Verarbeitung Verantwortlichen befindet, die
  ...
  Die im Blog der Piers Goffart / Lavamachine abgegebenen Kommentare können
  ...
  automatische Bestätigungsmail, um im Double-Opt-In-Verfahren zu überprüfen, ob
  ...
  Löschung von personenbezogenen Daten, die bei der Piers Goffart / Lavamachine
  ...
  der Piers Goffart / Lavamachine wird veranlassen, dass dem Löschverlangen
  unverzüglich nachgekommen wird.


  Wurden die personenbezogenen Daten von der Piers Goffart / Lavamachine
  öffentlich gemacht und ist unser Unternehmen als Verantwortlicher gemäß Art.
  17 Abs. 1 DS-GVO zur Löschung der personenbezogenen Daten verpflichtet, so
  trifft die Piers Goffart / Lavamachine unter Berücksichtigung der verfügbaren
  ...
  Die betroffene Person hat Widerspruch gegen die Verarbeitung gem. Art. 21 Abs.
  1 DS-GVO eingelegt und es steht noch nicht fest, ob die berechtigten Gründe
  ...
  Person die Einschränkung von personenbezogenen Daten, die bei der Piers
  Goffart / Lavamachine gespeichert sind, verlangen möchte, kann sie sich hierzu
  ...
  Die Piers Goffart / Lavamachine verarbeitet die personenbezogenen Daten im
  ...
  Verarbeitet die Piers Goffart / Lavamachine personenbezogene Daten, um
  ...
  gegenüber der Piers Goffart / Lavamachine der Verarbeitung für Zwecke der
  Direktwerbung, so wird die Piers Goffart / Lavamachine die personenbezogenen
  ...
  personenbezogener Daten, die bei der Piers Goffart / Lavamachine zu
  ...
  jeden Mitarbeiter der Piers Goffart / Lavamachine oder einen anderen
  ...
  Piers Goffart / Lavamachine angemessene Maßnahmen, um die Rechte und
  ...
  oder unternehmensbezogene Informationen bereitzustellen. Facebook ermöglicht
  den Nutzern des sozialen Netzwerkes unter anderem die Erstellung von privaten
  ...
  Im Rahmen dieses technischen Verfahrens erhält Facebook Kenntnis darüber,
  welche konkrete Unterseite unserer Internetseite durch die betroffene Person
  besucht wird.


  Sofern die betroffene Person gleichzeitig bei Facebook eingeloggt ist, erkennt
  Facebook mit jedem Aufruf unserer Internetseite durch die betroffene Person
  ...
  die jeweilige Google-AdSense-Komponente veranlasst, Daten zum Zwecke der
  ...
  Besucher und Klicks nachzuvollziehen und in der Folge Provisionsabrechnungen
  zu ermöglichen.
  ...
  kann ein von der Alphabet Inc. bereits gesetzter Cookie jederzeit über den
  ...
  von Amerika übertragen. Diese personenbezogenen Daten werden in den
  Vereinigten Staaten von Amerika gespeichert und verarbeitet. Die Alphabet Inc.
  gibt diese über das technische Verfahren erhobenen personenbezogenen Daten
  ...
  oder wie oft und für welche Verweildauer eine Unterseite betrachtet wurde.
  Eine Web-Analyse wird überwiegend zur Optimierung einer Internetseite und zur
  ...
  Google Analytics setzt ein Cookie auf dem informationstechnologischen System
  ...
  https://www.google.com/analytics/terms/de.html abgerufen werden. Google
  ...
  als audiovisuelle Plattform zu qualifizieren ist und den Nutzern das Teilen
  von Fotos und Videos und zudem eine Weiterverbreitung solcher Daten in anderen
  ...
  erkennt Instagram mit jedem Aufruf unserer Internetseite durch die betroffene
  ...
  integrierten Instagram-Buttons, werden die damit übertragenen Daten und
  Informationen dem persönlichen Instagram-Benutzerkonto der betroffenen Person
  ...
  also Kurznachrichten, die auf 280 Zeichen begrenzt sind, veröffentlichen und
  ...
  Person zugeordnet. Betätigt die betroffene Person einen der auf unserer
  Internetseite integrierten Twitter-Buttons, werden die damit übertragenen
  Daten und Informationen dem persönlichen Twitter-Benutzerkonto der betroffenen
  ...
  Person nicht gewollt, kann diese die Übermittlung dadurch verhindern, dass sie
  sich vor einem Aufruf unserer Internetseite aus ihrem Twitter-Account
  ausloggt.
  ...
  entsprechenden Xing-Komponente von Xing herunterzuladen. Weitere Informationen
  zum den Xing-Plug-Ins können unter https://dev.xing.com/plugins abgerufen
  werden. Im Rahmen dieses technischen Verfahrens erhält Xing Kenntnis darüber,
  welche konkrete Unterseite unserer Internetseite durch die betroffene Person
  besucht wird.
  ...
  Betätigt die betroffene Person einen der auf unserer Internetseite
  integrierten Xing-Buttons, beispielsweise den „Share“-Button, ordnet Xing
  diese Information dem persönlichen Xing-Benutzerkonto der betroffenen Person
  ...
  die Xing-Komponente anklickt oder nicht. Ist eine derartige Übermittlung
  dieser Informationen an Xing von der betroffenen Person nicht gewollt, kann
  diese die Übermittlung dadurch verhindern, dass sie sich vor einem Aufruf
  unserer Internetseite aus ihrem Xing-Account ausloggt.
  ...
  Erhebung, Verarbeitung und Nutzung personenbezogener Daten durch Xing. Ferner
  ...
  Betreibergesellschaft von YouTube ist die YouTube, LLC, 901 Cherry Ave., San
  ...
  Google Kenntnis darüber, welche konkrete Unterseite unserer Internetseite
  ...
  Internetseite gleichzeitig bei YouTube eingeloggt ist; dies findet unabhängig
  davon statt, ob die betroffene Person ein YouTube-Video anklickt oder nicht.
  Ist eine derartige Übermittlung dieser Informationen an YouTube und Google von
  ...
  Datenschutzbeauftragter Freising tätig ist, in Kooperation mit dem Anwalt für
