...
content: >-
  ...
  LAVAMACHINE. The use of the Internet pages of the LAVAMACHINE is possible
  ...
  data protection regulations applicable to the LAVAMACHINE. By means of this
  ...
  <p>As the controller, the LAVAMACHINE has implemented numerous technical and
  ...
  personal data to us via alternative means, e.g. by telephone.</p>
  ...
  <p>The data protection declaration of the LAVAMACHINE is based on the terms
  ...
  identifiable natural person (&ldquo;data subject&rdquo;). An identifiable
  ...
  <p>Restriction of processing is the marking of stored personal data with the
  aim of limiting their processing in the future.</p>
  ...
  <p>Pseudonymisation is the processing of personal data in such a manner that
  ...
  <li><strong>g)&nbsp;&nbsp;&nbsp; Controller or controller responsible for the
  processing</strong></li>

  </ul>

  <p>Controller or controller responsible for the processing is the natural or
  ...
  <p>Processor is a natural or legal person, public authority, agency or other
  body which processes personal data on behalf of the controller.</p>
  ...
  <p>Recipient is a natural or legal person, public authority, agency or another
  ...
  <p>Third party is a natural or legal person, public authority, agency or body
  ...
  <p>Bargteheider Str. 147a</p>

  <p>22143 Hamburg</p>

  <p>Germany</p>

  <p>Phone: 015779484085</p>

  <p>Email: mail@piersgoffart.com</p>

  <p>Website: www.lavamachine.com</p>
  ...
  <p>The website of the LAVAMACHINE collects a series of general data and
  ...
  <p>When using these general data and information, the LAVAMACHINE does not
  ...
  criminal prosecution in case of a cyber-attack. Therefore, the LAVAMACHINE
  analyzes anonymously collected data and information statistically, with the
  aim of increasing the data protection and data security of our enterprise, and
  to ensure an optimal level of protection for the personal data we process. The
  ...
  <p>The website of the LAVAMACHINE contains information that enables a quick
  ...
  <p>Each data subject shall have the right granted by the European legislator
  ...
  <li>the existence of automated decision-making, including profiling, referred
  ...
  and envisaged consequences of such processing for the data subject.</li>

  </ul>

  </ul>

  <p>Furthermore, the data subject shall have a right to obtain information as
  ...
  <p>If a data subject wishes to avail himself of this right of access, he or
  ...
  <p>If a data subject wishes to exercise this right to rectification, he or she
  ...
  the GDPR and there are no overriding legitimate grounds for the processing, or
  ...
  Union or Member State law to which the controller is subject.</li>
  ...
  <p>If one of the aforementioned reasons applies, and a data subject wishes to
  request the erasure of personal data stored by the LAVAMACHINE, he or she may,
  at any time, contact any employee of the controller. An employee of
  LAVAMACHINE shall promptly ensure that the erasure request is complied with
  immediately.</p>

  <p>Where the controller has made personal data public and is obliged pursuant
  ...
  as far as processing is not required. An employees of the LAVAMACHINE will
  arrange the necessary measures in individual cases.</p>
  ...
  <li>The accuracy of the personal data is contested by the data subject, for a
  period enabling the controller to verify the accuracy of the personal
  data.</li>

  <li>The processing is unlawful and the data subject opposes the erasure of the
  personal data and requests instead the restriction of their use instead.</li>

  <li>The controller no longer needs the personal data for the purposes of the
  processing, but they are required by the data subject for the establishment,
  exercise or defence of legal claims.</li>

  <li>The data subject has objected to processing pursuant to Article 21(1) of
  ...
  <p>If one of the aforementioned conditions is met, and a data subject wishes
  to request the restriction of the processing of personal data stored by the
  LAVAMACHINE, he or she may at any time contact any employee of the controller.
  The employee of the LAVAMACHINE will arrange the restriction of the
  processing.</p>
  ...
  <p>Furthermore, in exercising his or her right to data portability pursuant to
  ...
  <p>In order to assert the right to data portability, the data subject may at
  any time contact any employee of the LAVAMACHINE.</p>
  ...
  based on these provisions.</p>

  <p>The LAVAMACHINE shall no longer process the personal data in the event of
  the objection, unless we can demonstrate compelling legitimate grounds for the
  processing which override the interests, rights and freedoms of the data
  subject, or for the establishment, exercise or defence of legal claims.</p>

  <p>If the LAVAMACHINE processes personal data for direct marketing purposes,
  ...
  data subject objects to the LAVAMACHINE to the processing for direct marketing
  purposes, the LAVAMACHINE will no longer process the personal data for these
  purposes.</p>

  <p>In addition, the data subject has the right, on grounds relating to his or
  her particular situation, to object to processing of personal data concerning
  him or her by the LAVAMACHINE for scientific or historical research purposes,
  ...
  <p>In order to exercise the right to object, the data subject may contact any
  employee of the LAVAMACHINE. In addition, the data subject is free in the
  ...
  <li><strong>h) Automated individual decision-making, including
  profiling</strong></li>
  ...
  <p>If the decision (1) is necessary for entering into, or the performance of,
  a contract between the data subject and a data controller, or (2) it is based
  on the data subject's explicit consent, the LAVAMACHINE shall implement
  suitable measures to safeguard the data subject's rights and freedoms and
  ...
  <p>If the data subject wishes to exercise the rights concerning automated
  individual decision-making, he or she may, at any time, contact any employee
  of the LAVAMACHINE.</p>
  ...
  <p>If the data subject wishes to exercise the right to withdraw the consent,
  he or she may, at any time, contact any employee of the LAVAMACHINE.</p>

  <ol start="7">

  <li><strong> Data protection provisions about the application and use of
  Instagram</strong></li>
  ...
  disseminate such data in other social networks.</p>

  <p>The operating company of the services offered by Instagram is Instagram
  ...
  detects with every call-up to our website by the data subject&mdash;and for
  the entire duration of their stay on our Internet site&mdash;which specific
  sub-page of our Internet page was visited by the data subject. This
  information is collected through the Instagram component and is associated
  with the respective Instagram account of the data subject. If the data subject
  ...
  the data subject and stores the personal data.</p>
  ...
  and https://www.instagram.com/about/legal/privacy/.</p>
  ...
  which are not covered by any of the abovementioned legal grounds, if
  ...
  if the data subject is a client of the controller (Recital 47 Sentence 2
  GDPR).</p>

  <ol start="9">

  <li><strong> The legitimate interests pursued by the controller or by a third
  party</strong></li>
  ...
  well-being of all our employees and the shareholders.</p>
  ...
  <li><strong> Provision of personal data as statutory or contractual
  ...
  <p>This Privacy Policy has been generated by the Privacy Policy Generator of
  the <a href="https://dg-datenschutz.de/?lang=en">German Association for Data
  Protection</a> that was developed in cooperation with <a
  href="https://www.wbs-law.de/eng/practice-areas/internet-law/it-law/">Privacy
